...
public abstract class Piesa implements Comparable {
	...
	int getvaluepeca(Position p1,Board b)
	{
		Piesa paux=b.getPieceOnPosition(p1);
		int eval=0;
		//JOptionPane.showMessageDialog(null,  "Eggs are not supposed to be green.", null, score);
		if (paux !=null){
		switch ((char)(paux.hashCode())){
		case 'Q': eval += 9700; break;
		case 'R': eval += 500; break;
		case 'N': eval += 320; break;
		case 'B': eval += 320; break;
		case 'p': eval += 10; break;
		//case 'K': eval += 20000; break;
		default: break;
		}}
		//System.out.println("telluser o valor " +String.valueOf(eval));
		return eval;
	}
